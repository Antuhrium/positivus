...
const ServicesSection = () => {
  return (
    <section id="Services" className="content mt-[140px] flex flex-col w-full ">
      <SectionTitle
        title="Services"
      ...
      <div className="mt-20 grid grid-cols-1 lg:grid-cols-2 gap-10">
        {cards.map((card, i) => (
          <FadeY fled={"top"} key={card.firstTitle} delay={i * 0.1}>
            <div
              className={`flex p-[30px] sm:p-[50px] justify-between items-center
              ${card.bg} rounded-[45px] border border-black h-[320px] md:h-[310px] relative`}
            >

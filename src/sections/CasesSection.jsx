...
const CasesSection = () => {
    return (
        <section className="content mx-auto mt-[140px]">
            <SectionTitle
                title="Case Studies"
                ...
                {content.map((text, index) => (
                    <>
                        <div className="flex flex-col gap-[20px]">
                            ...
                            <a
                                href="#"
                                className="flex gap-4 items-center text-green"
                            >
                                Learn more
                                <ArrowSvg fill="#B9FF66" />
                            </a>
                        </div>
                        {index === content.length - 1 ? null : <div className="h-px w-full lg:h-full lg:min-h-[186px] lg:w-px bg-white" />}
                    </>
                ))}
            </div>
        </section>
